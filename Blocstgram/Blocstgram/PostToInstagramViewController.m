...
#import "CroppedCollectionViewCell.h"
...
-(void)viewDidLoad
{
    ...
    // Switch to the new subclass
    [self.filterCollectionView registerClass:[CroppedCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
